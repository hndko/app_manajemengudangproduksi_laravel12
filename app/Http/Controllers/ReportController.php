...
{
    public function index() { return view('backend.accounting.reports.index'); }
    public function balanceSheet() {
        ...
        return view('backend.accounting.reports.balance-sheet', compact('assets', 'liabilities', 'equity'));
    }
    public function incomeStatement() {
        $revenues = ChartOfAccount::ofType('pendapatan')->active()->get();
        $expenses = ChartOfAccount::ofType('beban')->active()->get();
        return view('backend.accounting.reports.income-statement', compact('revenues', 'expenses'));
    }
}
