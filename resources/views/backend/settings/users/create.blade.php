...
@section('subheader', 'Tambah pengguna baru ke sistem')
    ...
    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <!-- Password -->
                <div>
                    <label for="password" class="form-label">Password <span class="text-danger-400">*</span></label>
                    <div class="relative">
                        <input
                            type="password"
                            id="password"
                ...
                <div>
                    <label for="password_confirmation" class="form-label">Konfirmasi Password <span class="text-danger-400">*</span></label>
                    <div class="relative">
                        <input
                            type="password"
