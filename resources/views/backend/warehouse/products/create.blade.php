...
@section('subheader', 'Tambah data produk baru')
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="code" name="code" value="{{ old('code') }}" class="form-input pl-9 @error('code') border-danger-500 @enderror" placeholder="PRD-001" required>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-input pl-9 @error('name') border-danger-500 @enderror" placeholder="Nama produk" required>
                        <svg class="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path>
                        </svg>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" id="minimum_stock" name="minimum_stock" value="{{ old('minimum_stock', 0) }}" class="form-input pl-9 @error('minimum_stock') border-danger-500 @enderror" min="0" required>
                        <svg class="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" id="base_price" name="base_price" value="{{ old('base_price', 0) }}" class="form-input pl-9 @error('base_price') border-danger-500 @enderror" min="0" required>
            ...
            <div class="mt-4">
                ...
                <div class="relative">
                    <textarea id="description" name="description" rows="3" class="form-input pl-9 @error('description') border-danger-500 @enderror" placeholder="Deskripsi produk (opsional)">{{ old('description') }}</textarea>
            ...
            <div class="mt-4">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="is_active" value="1" class="w-4 h-4 rounded border-dark-border bg-dark-card text-primary-500" {{ old('is_active', true) ? 'checked' : '' }}>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    <label class="block">
                        ...
                        <span class="btn btn-secondary cursor-pointer">Pilih Gambar</span>
                    </label>
