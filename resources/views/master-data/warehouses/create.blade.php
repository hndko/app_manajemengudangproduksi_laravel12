...
@section('subheader', 'Tambah lokasi gudang baru')
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="code" name="code" value="{{ old('code') }}" class="form-input pl-9 @error('code') border-danger-500 @enderror" placeholder="GDG-01" required>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-input pl-9 @error('name') border-danger-500 @enderror" placeholder="Gudang Utama" required>
                        <svg class="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                        </svg>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" class="form-input pl-9 @error('phone') border-danger-500 @enderror" placeholder="08xxxxxxxxxx">
                        <svg class="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-4">
                ...
                <div class="relative">
                    <textarea id="address" name="address" rows="3" class="form-input pl-9 @error('address') border-danger-500 @enderror" placeholder="Alamat lengkap gudang">{{ old('address') }}</textarea>
