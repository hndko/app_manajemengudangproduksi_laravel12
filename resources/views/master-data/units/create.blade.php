...
@section('subheader', 'Tambah satuan pengukuran baru')
        ...
        <div class="card">
            <div class="space-y-4">
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-input pl-9 @error('name') border-danger-500 @enderror" placeholder="Contoh: Kilogram" required>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="symbol" name="symbol" value="{{ old('symbol') }}" class="form-input pl-9 @error('symbol') border-danger-500 @enderror" placeholder="Contoh: kg" required>
                        <svg class="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
